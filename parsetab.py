...
_lr_productions = [
  ...
  ('program -> for_loop','program',1,'p_program','app.py',78),
  ('for_loop -> FOR LPAREN INT IDENTIFIER EQUALS NUMBER SEMICOLON IDENTIFIER LESS_EQUAL NUMBER SEMICOLON increment RPAREN LBRACE statement RBRACE','for_loop',16,'p_for_loop','app.py',82),
  ('increment -> IDENTIFIER PLUS_PLUS','increment',2,'p_increment','app.py',86),
  ('increment -> IDENTIFIER PLUS EQUALS NUMBER','increment',4,'p_increment','app.py',87),
  ('statement -> SYSTEM DOT OUT DOT PRINTLN LPAREN STRING PLUS IDENTIFIER RPAREN SEMICOLON','statement',11,'p_statement','app.py',92),
]
